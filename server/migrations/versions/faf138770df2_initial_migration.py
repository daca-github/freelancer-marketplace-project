...
Revision ID: faf138770df2
Revises: 
Create Date: 2023-09-27 13:14:11.669243
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['freelancer_id'], ['users.id'], name=op.f('fk_reviews_freelancer_id_users')),
    sa.PrimaryKeyConstraint('id')
    )
